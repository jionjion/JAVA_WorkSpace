...
function send() {
	...
	$.ajax({
		url : $("#basePath").val() + "AutoReplyServlet",	//注意获取值栈的写法为:${"值中的名字"}.val()
		type : "POST",			//post提交方式
		dataType : "text",		//提交内容格式为文本
		timeout : 10000,		//超时时间
		success : function (data) {		//回调函数
			appendDialog("talk_recordboxme","My账号",content);	//公众号说的话
			appendDialog("talk_recordbox","公众号",data);			//我说的话
			$("#content").val("");	//文本框清空
			render();
		},

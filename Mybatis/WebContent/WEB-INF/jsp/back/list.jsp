...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body style="background: #e1e9eb;">
		<form action="${basePath }listServlet" id="mainForm" method="post">
			<div class="right">
				...
				<div class="rightCont">
					<p class="g_title fix">内容列表 <a class="btn03" href="#">新 增</a>&nbsp;&nbsp;&nbsp;&nbsp;<a class="btn03" href="javascript:deleteBatchMessage('<%=basePath %>')">删 除</a></p>
					<table class="tab1">
						<tbody>
							<tr>
							...
							<tbody>
								...
								<c:forEach items="${messagesList }" var="message" varStatus="status">
									<tr <c:if test="${status.index %2 != 0}">style="background-color:#ECF6EE;"</c:if>> 
									    ...
									    <td>
									    	<a href="">修改</a>&nbsp;&nbsp;&nbsp;
											<a href="${basePath}deleteOneMessageServlet?id=${message.id }">删除</a>
										</td>
									</tr>
								</c:forEach>
							</tbody>
	...
	<script>
		function deleteBatchMessage(basePath){
			$('#mainForm').attr('action',basePath+'deleteBatchMessageServlet')
			$('#mainForm').submit();
		}
	</script>
</html>